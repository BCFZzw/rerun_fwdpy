...
savePath = "/home/alouette/projects/ctb-sgravel/alouette/Dz_sweep_final/simulation_review/src/test/new_test"
...
n_sample = 1000
sim_region = int(5e6)
scaling_factor = Ne/n_sample ### scaling factor = 20
rec_rate = 1.25e-8 * scaling_factor
mut_rate = 1.44e-8 * scaling_factor
sel_coeff = 0.01 * scaling_factor
sim_gen = 200

### Mostly follow fwdpy11 vignette: https://molpopgen.github.io/fwdpy11/short_vignettes/selective_sweep.html
pdict = {
...
while sim_i < simulation_iteration:
    ...
    print("Sweep fixed at generation " + str(output.pop.fixation_times[0]))

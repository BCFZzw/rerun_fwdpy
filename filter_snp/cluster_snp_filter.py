...
def index_in_pairwise_list(arr: list, pair_ab: list) -> int:
    """
    Find the index of a given pair [a, b] in the pairwise comparison of an array with the same order generated by itertools.combinations(, 2).
    Assertion error if this pair is not found in the given array.
    """
